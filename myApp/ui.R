...
<<<<<<< HEAD
                                 ...
                                 br(), br(),
                                 "Link to github:", a("https://github.com/schlueterj/Developing_Data_Products_CourseProject3",href ="https://github.com/schlueterj/Developing_Data_Products_CourseProject3"),
                                 ),
=======
                                 "On tab 'Plot and Prediction' you can see a plot with the fitted regression line and data and the predicted value based on your slider input."),
>>>>>>> e62598910345f6fecf7fc3440a952092286e2b17
